...
public class SimpleSideDrawer extends FrameLayout {
    ...
    public View setLeftBehindContentView(int leftBehindLayout) {
        ...
        setmLeftPaddingRect(new Rect(content.getPaddingLeft(), content.getPaddingTop(), content.getPaddingRight(), content.getPaddingBottom()));
    ...
    public View setRightBehindContentView(int rightBehindLayout) {
        ...
        setmRightPaddingRect(new Rect(content.getPaddingLeft(), content.getPaddingTop(), content.getPaddingRight(), content.getPaddingBottom()));
